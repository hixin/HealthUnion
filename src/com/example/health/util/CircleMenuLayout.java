...
public class CircleMenuLayout extends ViewGroup
{
	...
	{
		boolean itemTouch(View v, MotionEvent event, int pos);

		void itemCenterTouch(View v, MotionEvent event);
	}

	/**
	 * MenuItem的触摸事件接口
	 */
	private OnMenuItemTouchListener mOnMenuItemTouchListener;
	 ...
	 * @param mOnMenuItemClickListener
	 */
	public void setOnMenuItemTouchListener(
			OnMenuItemTouchListener mOnMenuItemTouchListener)
	{
		this.mOnMenuItemTouchListener = mOnMenuItemTouchListener;
	}
...
//				return true;
			...
			else if (Math.abs(mTmpAngle) > NOCLICK_VALUE)
			{
				setDisClick(true);
//				return true;
			}
		...
		for (int i = 0; i < mMenuItemCount; i++)
		{
			...
			if (iv != null)
			{
				...
				iv.setOnTouchListener(new OnTouchListener() {					
					@Override
					public boolean onTouch(View v, MotionEvent event) {
						if(mOnMenuItemTouchListener != null) {
							return mOnMenuItemTouchListener.itemTouch(v, event, j);
						}
						return false;
					}
				});
	...
	public boolean isDisClick() {
		return isDisClick;
	}

	public void setDisClick(boolean isDisClick) {
		this.isDisClick = isDisClick;
	}
