...
import com.example.health.bpchart.SalesStackedBarChart;
import com.example.health.bpdummy.DummyContentBO;
/**
 ...
 * on handsets.
 */
public class FragmentDetailTwoBO extends Fragment {
     ...
     */
    private DummyContentBO.DummyItem mItem;

    /**
     * Mandatory empty constructor for the fragment manager to instantiate the
     * fragment (e.g. upon screen orientation changes).
     */
    public FragmentDetailTwoBO() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = DummyContentBO.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));     
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	View rootView = inflater.inflate(R.layout.bo_fragment_item_detail2, container, false);
        if (mItem != null) {
        	...
        	List<BloodOx> data = (ArrayList<BloodOx>) GeneralDbHelper.getInstance(MyApplication.getContext()).getBeanList(bloodox,MainActivity.userID);
        	
//        	mChartView7 = new AverageTemperatureChart().getView(getActivity(),7);
        	mChartView7 = new SalesStackedBarChartBO().getView(getActivity(),7);
        	mChartView30 = new SalesStackedBarChartBO().getView(getActivity(),30);
        	mChartViewAll = new SalesStackedBarChartBO().getView(getActivity());
        	LogUtil.i("2",TAG);
    ...
    class ListViewAdapter extends BaseAdapter{
    	...
    	public ListViewAdapter(List<BloodOx> list,Context context){
    		this.list = list;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			 ...
			 View view = inflater.inflate(R.layout.bo_data_list, null);
			 
             TextView tvDate = (TextView)view.findViewById(R.id.item_date);
             tvDate.setText((CharSequence) list.get(position).getTime());
             
             TextView tvOx = (TextView)view.findViewById(R.id.item_oximeter);
             tvOx.setText(list.get(position).getOx()+"%");
